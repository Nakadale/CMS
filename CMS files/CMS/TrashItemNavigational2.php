...
where files.published IN (1,0) AND files.cat_id = '14' order by date_added DESC";

$objQuery = mysqli_query($objConnect,$strSQL) or die ("Error Query [".$strSQL."]");
?>

	<?php //create the header for the table and start of the form and input ?>
	<form action="TrashItemNavigational2.php" method="GET" name="frmPublish">
	...
	<tr class="NoticeTr">
		...
		<th class="OtherTH" style="width:25%"> Trash </th>
	</tr>
		<?php 
				...
				<input name="btnPublish" type="button" value="Trash File" onClick="frmPublish.PublishBtn.value='publish';frmPublish.id.value='<?php echo $objResult["file_id"]; ?>';frmPublish.submit();">
