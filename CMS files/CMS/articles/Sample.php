...
?>
	...
	<div class="rightBodyHeading" style="margin-top:50px;">DOWNLOADS</div>
		...
		?>
			...
			<div class="downloadsTitle"><a href="/cms2/jdownloads/<?php echo $objResult["cat_dir"];?>/<?php echo $objResult["url_download"];?>" target="_blank"><?php echo $objResult["file_title"];?></a></div>
			</div>
		<?php
		}
		?>
