			...
			if(count($this->fields))
			{
				foreach ($this->fields as $field) 
				{
					...
					<div class="control-group f2c_field <?php echo 'f2c_' . $field->fieldname; ?>">
						<div class="control-label f2c_field_label"><?php echo $this->renderer->renderFieldLabel($field); ?></div>
						<div class="controls f2c_field_value"><?php echo $this->renderer->renderField($field, $parms); ?></div>
					</div>
					<?php
				}
			}
