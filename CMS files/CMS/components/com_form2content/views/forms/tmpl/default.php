...
<div class="f2c-articlemanager<?php echo htmlspecialchars($this->params->get('pageclass_sfx')); ?>">
	...
	<div id="filter-bar2" class="btn-toolbar">	
		...
		<div class="filter-search btn-group pull-left">		
			...
			<button type="button" class="btn tip" style="margin-top: -10px;" onclick="document.id('filter_search').value='';this.form.submit();"><?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?></button>
		</div>
		<?php endif; ?>
						...
						<div class="pull-left">
							<?php
									...
									if($canChange)
									{
										...
										if ($item->featured) :
											JHtml::_('dropdown.unfeatured', 'cb' . $i, 'forms.');
										else :
											JHtml::_('dropdown.featured', 'cb' . $i, 'forms.');
										endif;
									...
									{
										if ($trashed) :
											JHtml::_('dropdown.untrash', 'cb' . $i, 'forms.');
										else :
