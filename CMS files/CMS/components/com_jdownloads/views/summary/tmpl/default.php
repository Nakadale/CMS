...
defined('_JEXEC') or die('Restricted access');
    ...
    if ($layout_text != ''){
        ...
        // summary pic
        $sumpic = '<img src="'.JURI::base().'components/com_jdownloads/assets/images/summary.png" width="'.$jlistConfig['cat.pic.size'].'" height="'.$jlistConfig['cat.pic.size.height'].'" border="0" alt="" /> ';
