                ...
                <div class="formelm">                
                   ...
                   <!-- not used currently
                    <?php if ($this->item->file_pic != ''){ ?>
                        <img src="<?php echo JURI::root().'images/jdownloads/fileimages/'.$this->item->file_pic; ?>" name="imagelib" alt="" />
                    <?php } else { ?>
                         <img src="<?php echo JURI::root().'images/jdownloads/fileimages/'.$jlistConfig['file.pic.default.filename']; ?>" name="imagelib" alt="" />
                    <?php } ?>
                   -->
