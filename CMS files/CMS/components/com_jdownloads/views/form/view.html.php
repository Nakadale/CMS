	...
	public function display($tpl = null)
	{
        ...
        function add_new_image_file(field)
        {
            ...
            if (count+sum < max){
                ...
                row.id = "new_file_row";
                var cell0 = row.insertCell(0);
                cell0.innerHTML = \'<input type="file" name="file_upload_thumb[\'+count+\']" id="file_upload_thumb[\'+count+\']" size="40" accept="image/gif,image/jpeg,image/jpg,image/png" readonly="readonly" onchange="add_new_image_file(this)" />\';   
            }
		...
		if (empty($this->item->file_id)) {
			$authorised = $user->authorise('core.create', 'com_jdownloads') || (count($user->getAuthorisedCategories('com_jdownloads', 'core.create')));
		}
		else {
