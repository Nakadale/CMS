 ...
 */
 ...
 defined('_JEXEC') or die('Restricted access');
    ...
    if ($header != ''){
        ...
        $upload_link = '<a href="'.JRoute::_('index.php?option=com_jdownloads&amp;view=upload&amp;Itemid='.$menuItemids['upload']).'">'.'<img src="'.JURI::base().'components/com_jdownloads/assets/images/upload.png" width="32" height="32" border="0" alt="" /></a> <a href="'.JRoute::_('index.php?option=com_jdownloads&amp;view=upload&amp;Itemid='.$menuItemids['upload'].'').'">'.JText::_('COM_JDOWNLOADS_UPLOAD_LINKTEXT').'</a>';
