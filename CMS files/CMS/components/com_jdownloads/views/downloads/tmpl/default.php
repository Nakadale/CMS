 ...
 defined('_JEXEC') or die('Restricted access');
    ...
    if ($layout_files_text != ''){
        ...
        if (isset($user_can_seen_download_url)){ 
            ...
            if ($total_downloads > 0){
                $body = str_replace('{checkbox_top}', '<div style="text-align:center; padding:8px;"><img src="'.JURI::base().'components/com_jdownloads/assets/images/info32.png" align="middle" width="32" height="32" border="0" alt="" /> '.$regg.'</div>', $body);                    
            } else {
                $body = str_replace('{checkbox_top}', '', $body);                    
            }    
        } 
