...
class jdownloadsModelDownloads extends JModelList
{
	...
	protected function populateState($ordering = 'ordering', $direction = 'ASC')
	{
        ...
        $limit = $app->getUserStateFromRequest('com_jdownloads.downloads.limit', 'limit',  '', 'uint');
        if (!$limit){
	...
	function getListQuery()
	{
		...
		$query->select(
			$this->getState(
                ...
                'a.license, a.url_license, a.size, a.date_added, a.file_date, a.publish_from, a.publish_to, a.use_timeframe, a.url_download, a.preview_filename, '.
		...
		$query->group('a.file_id, a.file_title, a.file_alias, a.description, a.description_long, a.file_pic, a.images, a.price, a.release, a.file_language, a.system, a.license, a.url_license, a.size, a.date_added, a.file_date, a.publish_from, a.publish_to, a.use_timeframe, a.url_download, a.preview_filename, a.other_file_id, a.md5_value, a.sha1_value, a.extern_file, a.extern_site, a.mirror_1, a.mirror_2, a.extern_site_mirror_1, a.extern_site_mirror_2, a. url_home, a.author, a.url_author, a.created_by, a.created_id, a.created_mail, a.modified_id, a.modified_date, a.submitted_by, a.downloads, a.set_aup_points, a.downloads, a.cat_id, a.notes, a.changelog, a.password_md5, a.views, a.tags, a.metakey, a.metadesc, a.robots, a.update_active, a.custom_field_1, a.custom_field_2, a.custom_field_3, a.custom_field_4, a.custom_field_5, a.custom_field_6, a.custom_field_7, a.custom_field_8, a.custom_field_9, a.custom_field_10, a.custom_field_11, a.custom_field_12, a.custom_field_13, a.custom_field_14, a.access, a.language, a.ordering, a.published, a.checked_out, a.checked_out_time, a.asset_id,
                       uam.id, uam.name, badcats.id, c.id, c.title, c.access, c.alias, c.published, c.lft, ua.name, ua.email, parent.title, parent.id, parent.alias, parent.lft'); 
		return $query;
	}
