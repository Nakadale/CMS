...
<section>
<!-- <div class="small dropdown" href="#"> 
Forgot Password / Username? 
   <ul style="top: 28px !important;">
        <li>
            <a class="forgot" href="<?php //echo JRoute::_('index.php?option=com_users&view=reset'); ?>">
                <?php //echo JText::_('COM_USERS_LOGIN_RESET'); ?></a>
        </li>
        <li>
            <a class="forgot" href="<?php //echo JRoute::_('index.php?option=com_users&view=remind'); ?>">
