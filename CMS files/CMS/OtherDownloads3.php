		...
		<?php 
			...
			$tableloop = $num3;
				...
				while ($count != $tableloop )
					...
					echo "<a href='/cms2/jdownloads/". $objResult1["cat_dir"] ."/" . $objResult1["Publications"] . "'>" . $objResult1["file_title"]. "</a>";
					echo "</td>";	
					echo "<td class='Othertd' style='width:33.3%'>";
					
					echo "<a href='/cms2/jdownloads/". $objResult2["cat_dir"] ."/" . $objResult2["Others"] . "'>" . $objResult2["file_title"]. "</a>";	
					echo "</td></tr>";	
					$count++;
